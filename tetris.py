...
start_bgrnd = pygame.image.load('assets/start_bgrnd.png')
bgrnd_img = pygame.transform.scale(bgrnd_img,(width,height))
...
# Shapes also knows as Tetrominos > https://tetris.fandom.com/wiki/Tetromino
